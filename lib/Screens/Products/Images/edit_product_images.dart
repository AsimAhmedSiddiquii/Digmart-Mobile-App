...
class EditProductImages extends StatefulWidget {
  final String slugID;
  const EditProductImages({super.key, required this.slugID});

  @override
  State<EditProductImages> createState() => _EditProductFashionState();
}

class _EditProductFashionState extends State<EditProductImages> {
  ...
  getProductImages() async {
    ...
    var prodImgArr = result["product"]["images"].cast<String>();
    if (prodImgArr.length != 0) {
      setState(() {
        images = prodImgArr;
      });
    }
  ...
  editProductImages() async {
    final url = Uri.parse('$urlPrefix/seller/product/edit-product-images');
